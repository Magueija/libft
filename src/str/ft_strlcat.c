...
/*   Updated: 2021/10/27 12:49:17 by tosilva          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @param	src [const char *] the string to be added to the 
 *				end of dest
 * @param	size [size_t] the size to concatenate
 * @returns	[size_t] the total length of the string it 
