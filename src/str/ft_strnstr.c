...
/*   Updated: 2021/10/27 13:05:35 by tosilva          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @param	haystack [const char *] string for the search
 * @param	needle [const char *] string to be searched in 'haystack'
 * @param	n [size_t] number of bytes to be searched
 * @returns	[char *] If 'needle' is an empty string, 'haystack' is returned; 
