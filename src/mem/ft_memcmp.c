...
/*   Updated: 2021/10/27 11:58:54 by tosilva          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @param	s1 [const void *] memory to be compared with 's2'
 * @param	s2 [const void *] memory to be compared with 's1'
 * @param	n [size_t] number of bytes to compare
 * @returns	[void *] returns an integer less than, equal to, 
